...
![emotion-style-tag-ssr](/public/configure-ssr-emotion-nextjs/emotion-ssr-tag.png)

while, the other style tag gets injected during CSR.

![emotion-style-tag](/public/configure-ssr-emotion-nextjs/emotion-csr-tag.png)
