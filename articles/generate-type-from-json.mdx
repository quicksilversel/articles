...
I wanted to automate the generation of TypeScript types based on JSON data fetched from a CMS. There are several libraries out there for this, like [quicktype](https://github.com/glideapps/quicktype/tree/master) and [json-schema-to-typescript](https://github.com/bcherny/json-schema-to-typescript#readme), but for some reason, they didn't work for me. So, I decided to write my own solution. In this article, I'll show you the code I came up with to automatically generate TypeScript types from a JSON file.
